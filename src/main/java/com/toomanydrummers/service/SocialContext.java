...
import com.toomanydrummers.config.FacebookConfig;
...
public class SocialContext implements ConnectionSignUp, SignInAdapter {
	...
	public SocialContext(UsersConnectionRepository connectionRepository, UserCookieGenerator userCookieGenerator, Facebook facebook)
	{
	...
	public boolean isSignedIn(HttpServletRequest request, HttpServletResponse response)
	{
		...
		logger.info("Reading cookie: '" + userId + "'");
		if (isValidId(userId)) {
